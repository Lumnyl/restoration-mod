...
action_variants.marshal_marksman_scripted = security_variant
...
action_variants.weekend_dmr_scripted = security_variant
...
action_variants.tank_hw_minion = clone(security_variant)
action_variants.tank_hw_minion.walk = TankCopActionWalk
...
--To fix shield knocking acting off for clients
